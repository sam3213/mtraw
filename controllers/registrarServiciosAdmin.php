<?php
    ...
    // $descripcion=$_POST['descripcion'];
        ...
        if (strlen($nomservicio)>0 && strlen($proveedor) >0 &&  strlen($descripcion)>0 ) {
            ...
            $result = $objConsultas -> insertarServicioAdmin($nomservicio,$proveedor,$descripcion,$foto1);

        }
        else{
            echo '<script> alert("Por favor complete todos los campos") </script>';
            echo "<script>location.href='../views/administrador/registrarServicio.php'</script>";
        }
